...
public class AxisAlignedBB
{
     ...
     *  
     * @param x Amount to change by in the x direction. If positive, decreases {@link #maxX}. If negative, increases
     * {@link #minX}.
     * @param y Amount to change by in the y direction. If positive, decreases {@link #maxY}. If negative, increases
     * {@link #minY}.
     * @param z Amount to change by in the z direction. If positive, decreases {@link #maxZ}. If negative, increases
     * {@link #minZ}.
     */
     ...
     * <tr><td><pre><code>new AxisAlignedBB(0, 0, 0, 1, 1, 1).addCoord(-2, -2,
     * -2)</code></pre></td><td><pre><samp>box[-2, -2, -2 -> 1, 1, 1]</samp></pre></td><td>
     ...
     *  
     * @param x Amount to change by in the x direction. If positive, increases {@link #maxX}. If negative, decreases
     * {@link #minX}.
     * @param y Amount to change by in the y direction. If positive, increases {@link #maxY}. If negative, decreases
     * {@link #minY}.
     * @param z Amount to change by in the z direction. If positive, increases {@link #maxZ}. If negative, decreases
     * {@link #minZ}.
     */
     ...
     * <tr><td><pre><code>new AxisAlignedBB(1, 1, 1, 3, 3, 3).expand(-4, -2,
     * -3)</code></pre></td><td><pre><samp>box[-1.0, 1.0, 0.0 -> 5.0, 3.0, 4.0]</samp></pre></td></tr>
     * </table>
     *  
     * <h3>See Also:</h3>
     * <ul>
     ...
     *  
     * @param x Distance to grow/shrink on the x axis.
     * @param y Distance to grow/shrink on the y axis.
     * @param z Distance to grow/shrink on the z axis.
     */
     ...
     *  
     * @param value Distance to expand by on all axes.
     */
     ...
     * @return A modified AABB.
     *  
     * @param value Distance to contract by on all axes.
     */
