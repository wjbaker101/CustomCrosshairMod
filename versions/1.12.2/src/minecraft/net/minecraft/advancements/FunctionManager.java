...
public class FunctionManager implements ITickable
{
    ...
    private final ICommandSender field_193073_g = new ICommandSender()
    {
        ...
        {
            return FunctionManager.this.field_193069_c.worlds[0];
        }
    ...
    {
        return this.field_193069_c.worlds[0].getGameRules().getInt("maxCommandChainLength");
    }
    ...
    public void update()
    {
        String s = this.field_193069_c.worlds[0].getGameRules().getString("gameLoopFunction");
