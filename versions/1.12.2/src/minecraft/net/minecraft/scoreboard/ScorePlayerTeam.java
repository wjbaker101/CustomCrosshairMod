...
public class ScorePlayerTeam extends Team
{
     ...
     *  
     * @param input The text (usually a player/entity name) to format
     */
     ...
     *  
     * @param teamIn The team to format for. May be null, in which case {@code string} is returned directly.
     * @param string The text (usually a player/entity name) to format
     */
     ...
     *  
     * @param color The new color. Should only be one of the color {@link TextFormatting} constants or {@link
     * TextFormatting#RESET}; must not be null.
     */
