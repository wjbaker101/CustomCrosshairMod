...
public class EntityList
{
     ...
     *  
     * @param entityIn The entity to get the identifier for
     */
     ...
     *  
     * @param entityIn The entity class to get the identifier for
     */
     ...
     *  
     * @param entityIn The entity to get the original name for
     */
     ...
     *  
     * @param entityType The current {@link ResourceLocation} for the entity
     */
     ...
     *  
     * @param clazz The type of entity to create
     * @param worldIn The world to pass to the entity's constructor
     */
     ...
     * @return The newly created entity, or null if creation failed
     *  
     * @param name The {@link ResourceLocation} specifying the type of entity to create.
     * @param worldIn The world to pass to the entity's constructor
     */
     ...
     *  
     * @param nbt The NBT to load the entity with. The entity's type is determined by the "id" tag within this NBT.
     */
     ...
     * @param entityName The type to check
     */
