...
public class Chunk
{
     ...
     * @param availableSections A bit mask of the sections in this data
     * @param groundUpContinuous True if this contains all sections in the chunk, false otherwise
     */
