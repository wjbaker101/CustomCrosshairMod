    ...
    public boolean func_192750_a(Advancement p_192750_1_, String p_192750_2_)
    {
        ...
        if (advancementprogress.func_192109_a(p_192750_2_))
        {
            ...
            if (!flag1 && advancementprogress.func_192105_a())
            {
                ...
                {
                    this.field_192756_d.getPlayerList().sendMessage(new TextComponentTranslation("chat.type.advancement." + p_192750_1_.func_192068_c().func_192291_d().func_192307_a(), new Object[] {this.field_192762_j.getDisplayName(), p_192750_1_.func_193123_j()}));
                }
            }
        }
