...
public class DamageSourcePredicate
{
    ...
    public boolean func_193418_a(EntityPlayerMP p_193418_1_, DamageSource p_193418_2_)
    {
        ...
        else if (!this.field_193419_i.func_192482_a(p_193418_1_, p_193418_2_.getImmediateSource()))
        {
            return false;
        }
        else
        {
            return this.field_193420_j.func_192482_a(p_193418_1_, p_193418_2_.getTrueSource());
        }
    }
