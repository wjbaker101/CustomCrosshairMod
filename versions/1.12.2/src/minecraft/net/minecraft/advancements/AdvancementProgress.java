...
public class AdvancementProgress implements Comparable<AdvancementProgress>
{
    ...
    {
        p_192104_1_.writeVarInt(this.field_192110_a.size());
    ...
    public static AdvancementProgress func_192100_b(PacketBuffer p_192100_0_)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            advancementprogress.field_192110_a.put(p_192100_0_.readString(32767), CriterionProgress.func_192149_a(p_192100_0_, advancementprogress));
        }
