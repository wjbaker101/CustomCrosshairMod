    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        if (player.canPlayerEdit(pos.offset(facing), facing, itemstack) && iblockstate.getBlock() == Blocks.END_PORTAL_FRAME && !((Boolean)iblockstate.getValue(BlockEndPortalFrame.EYE)).booleanValue())
        {
            ...
            else
            {
                ...
                worldIn.playSound((EntityPlayer)null, pos, SoundEvents.field_193781_bp, SoundCategory.BLOCKS, 1.0F, 1.0F);
        ...
        else
        {
            ...
            if (!worldIn.isRemote)
            {
                ...
                if (blockpos != null)
                {
                    ...
                    {
                        CriteriaTriggers.field_192132_l.func_192239_a((EntityPlayerMP)playerIn, blockpos);
                    }
