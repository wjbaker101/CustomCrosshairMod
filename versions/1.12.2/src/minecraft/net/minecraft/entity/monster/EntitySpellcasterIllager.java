...
public abstract class EntitySpellcasterIllager extends AbstractIllager
{
    ...
    public abstract class AIUseSpell extends EntityAIBase
    {
        ...
        public void startExecuting()
        {
            this.field_193321_c = this.getCastWarmupTime();
            EntitySpellcasterIllager.this.field_193087_b = this.getCastingTime();
            this.field_193322_d = EntitySpellcasterIllager.this.ticksExisted + this.getCastingInterval();
