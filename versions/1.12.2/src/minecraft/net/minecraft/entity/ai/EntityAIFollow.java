...
public class EntityAIFollow extends EntityAIBase
{
    ...
    {
        List<EntityLiving> list = this.field_192372_a.world.<EntityLiving>getEntitiesWithinAABB(EntityLiving.class, this.field_192372_a.getEntityBoundingBox().grow((double)this.field_192380_i), this.field_192373_b);
